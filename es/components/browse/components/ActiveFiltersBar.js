...
export var ActiveFiltersBar = /*#__PURE__*/function (_React$PureComponent) {
  function ActiveFiltersBar(props) {
    ...
    _this2 = _callSuper(this, ActiveFiltersBar, [props]);
    _this2.updateHoverNodes = _.throttle(_this2.updateHoverNodes.bind(_this2), 200);
    _this2.renderCrumbs = _this2.renderCrumbs.bind(_this2);
    _this2.memoized = {
