...
export var ControlsAndResults = /*#__PURE__*/function (_React$PureComponent) {
  function ControlsAndResults(props) {
    ...
    _this2 = _callSuper(this, ControlsAndResults, [props]);
    _this2.onClearFiltersClick = _this2.onClearFiltersClick.bind(_this2);
    ...
    _this2.searchResultTableRef = /*#__PURE__*/React.createRef();
    return _this2;
  }
  _inherits(ControlsAndResults, _React$PureComponent);
  return _createClass(ControlsAndResults, [{
