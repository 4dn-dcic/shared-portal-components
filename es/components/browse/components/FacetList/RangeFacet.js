    ...
    value: function render() {
      ...
      if (field_type === "number" || field_type === "integer") {
        if (aggregation_type === "stats") {
          ...
          var _ranges$2 = ranges[0],
              firstRange = _ranges$2 === void 0 ? null : _ranges$2;
    ...
    value: function (facet) {
      ...
      if (Array.isArray(increments)) {
        ...
        var _ref5 = increments || {},
            _ref4$from2 = _ref5.from,
            fromIncrementsOrig = _ref4$from2 === void 0 ? [] : _ref4$from2,
            _ref4$to2 = _ref5.to,
            toIncrementsOrig = _ref4$to2 === void 0 ? [] : _ref4$to2;
