...
export var FacetList = /*#__PURE__*/function (_React$PureComponent) {
  function FacetList(props) {
    ...
    _this2.onToggleIncluding = _this2.onToggleIncluding.bind(_this2);
    _this2.memoized = {
  ...
  return _createClass(FacetList, [{
    ...
    value: function render() {
      var _this$props6 = this.props,
        ...
        _this$props6$maxFacet = _this$props6.maxFacetsBodyHeight,
        maxFacetsBodyHeight = _this$props6$maxFacet === void 0 ? null : _this$props6$maxFacet,
      ...
      var bodyProps = {
        ...
        style: typeof maxFacetsBodyHeight === "number" ? {
          maxHeight: maxFacetsBodyHeight
        } : null
      };
