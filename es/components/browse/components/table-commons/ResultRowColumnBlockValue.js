...
export var ResultRowColumnBlockValue = /*#__PURE__*/function (_React$Component) {
  function ResultRowColumnBlockValue(props) {
    ...
    _this2 = _callSuper(this, ResultRowColumnBlockValue, [props]);
    _this2.memoized = {
  ...
  return _createClass(ResultRowColumnBlockValue, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if (nextProps.columnNumber === 0 ||
      // Update title column more frequently as it has expansion controls, checkboxes, etc.
    ...
    function transformIfNeeded(result, field, termTransformFxn) {
      ...
      var uniquedValuesLen = uniquedValues.length;
