        ...
        ajax.promise(destination, actionMethod, {}, payload).then(function (response) {
          if (response.status && response.status !== 'success') {
            ...
            if (roundTwo) {
              ...
              if (inKey !== 0) {
                var _findFieldFromContext2 = findFieldFromContext(contextCopy[parentKey], typesCopy[parentKey], schemas, inKey, responseData['@type']),
                    splitField = _findFieldFromContext2.splitField,
                    arrayIdx = _findFieldFromContext2.arrayIdx; // console.log('Results from findFieldFromContext', splitField, arrayIdx);
