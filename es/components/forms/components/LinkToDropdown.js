...
export var LinkToDropdown = /*#__PURE__*/function (_React$PureComponent) {
  function LinkToDropdown(props) {
    ...
    _this2 = _callSuper(this, LinkToDropdown, [props]);
    _this2.loadViableOptions = _this2.loadViableOptions.bind(_this2);
    ...
    _this2.searchCache = new Map();
    return _this2;
  }
  _inherits(LinkToDropdown, _React$PureComponent);
  return _createClass(LinkToDropdown, [{
