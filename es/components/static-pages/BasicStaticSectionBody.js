...
_react["default"].memo(function (props) {
  ...
  if (filetype === 'md' && typeof content === 'string') {
    return (
      /*#__PURE__*/
      _react["default"].createElement(element, passProps, (0, _markdownToJsx.compiler)(content, markdownCompilerOptions || undefined))
    );
  } else if (filetype === 'html' && typeof content === 'string') {
    return (
      /*#__PURE__*/
      _react["default"].createElement(element, passProps, (0, _object.htmlToJSX)(content))
    );
    ...
    return (
      /*#__PURE__*/
      _react["default"].createElement(element, passProps, content)
    );
  }
});
