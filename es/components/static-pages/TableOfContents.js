    ...
    value: function render() {
      ...
      var renderedSections = _.sortBy(context.content, function (s) {
        ...
        if (excludeSectionsFromTOC) {
          ...
          var _TableEntryChildren$g2 = TableEntryChildren.getHeadersFromContent(content, maxHeaderDepth, 1),
              childHeaders = _TableEntryChildren$g2.childHeaders,
              childDepth = _TableEntryChildren$g2.childDepth;
