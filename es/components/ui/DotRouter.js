...
export var TabPaneErrorBoundary = /*#__PURE__*/function (_React$PureComponent) {
  function TabPaneErrorBoundary(props) {
    ...
    _this2 = _callSuper(this, TabPaneErrorBoundary, [props]);
    _this2.state = {
      hasError: false
    };
    return _this2;
  ...
  return _createClass(TabPaneErrorBoundary, [{
...
export var DotRouter = /*#__PURE__*/function (_React$PureComponent2) {
  function DotRouter(props) {
    ...
    _this3 = _callSuper(this, DotRouter, [props]);
    _this3.getCurrentTab = _this3.getCurrentTab.bind(_this3);
    _this3.memoized = {
