...
_defineProperty(Detail, "defaultProps", {
  ...
  'aliases'],
  'alwaysCollapsibleKeys': ['@type', 'accession', 'schema_version', 'uuid', 'replicate_exps', 'dbxrefs', 'status', 'external_references', 'date_created', 'last_modified', 'project_release', 'short_attribution', 'validation-errors'],
  'open': null,
  'columnDefinitionMap': {
    '@id': {
      'title': 'Link',
