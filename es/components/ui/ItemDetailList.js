...
var SubItemTable = /*#__PURE__*/function (_React$Component) {
  function SubItemTable(props) {
    ...
    _this2 = _callSuper(this, SubItemTable, [props]);
    _this2.state = {
      'mounted': false
    };
    return _this2;
  ...
  return _createClass(SubItemTable, [{
...
var DetailRow = /*#__PURE__*/function (_React$PureComponent) {
  function DetailRow(props) {
    ...
    _this3 = _callSuper(this, DetailRow, [props]);
    ...
    value: function render() {
      ...
      if (value.type === "ol" && value.props.children[0] && value.props.children[0].type === "li" && value.props.children[0].props.children && value.props.children[0].props.children.type === SubItemTitle) {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          return /*#__PURE__*/React.createElement(DetailRow, _extends({}, _this4.props, {
...
export var Detail = /*#__PURE__*/function (_React$PureComponent2) {
  function Detail(props) {
    ...
    _this5 = _callSuper(this, Detail, [props]);
    _this5.renderDetailRow = _this5.renderDetailRow.bind(_this5);
    _this5.memoized = {
...
export var ItemDetailList = /*#__PURE__*/function (_React$PureComponent3) {
  function ItemDetailList(props) {
    ...
    _this6 = _callSuper(this, ItemDetailList, [props]);
    _this6.handleToggleJSON = _this6.handleToggleJSON.bind(_this6);
    _this6.handleToggleCollapsed = _this6.handleToggleCollapsed.bind(_this6);
    _this6.state = {
      'collapsed': true,
      'showingJSON': false
    };
  ...
  return _createClass(ItemDetailList, [{
