...
var defaultOptions = {
  ...
  "itemToProductTransform": function (item) {
    ...
    if (typeof file_type_detailed === "string") {
      ...
      var _file_type_detailed$m3 = file_type_detailed.match(/(.*?)\s(\(.*?\))/),
          _file_type_detailed$m4 = _slicedToArray(_file_type_detailed$m3, 3),
          fileTypeMatch = _file_type_detailed$m4[1],
          fileFormatMatch = _file_type_detailed$m4[2];
