...
export var object = objectMethods;
...
export var analytics = analyticsMethods;

// Layout
import * as layoutMethods from './layout';
export var layout = layoutMethods;

// AJAX
import * as ajaxMethods from './ajax';
export var ajax = ajaxMethods;

// Reporting
import * as loggerMethods from './logger';
export var logger = loggerMethods;
...
export var console = patchedConsoleInstance;

// Type definitions
import * as typeDefinitions from './typedefs';
export var typedefs = typeDefinitions;
...
export var searchFilters = searchFiltersImported;
...
export var valueTransforms = valueTransformsImported;

// Transforms, manipulations, parsers, etc. re: objects.
import * as fileUtilities from './file';
export var commonFileUtil = fileUtilities;
